        ...
        <div id="toppanel">
            <div id="panel">
                <div class="content clearfix">
                    ...
                    <div class="left">
                        <!-- Login Form -->
                        <form class="clearfix" action="index.php?method=initiateLogin&controller=Main" method="post" id="register-form">
                    ...
                    <div class="left right">			
                        <!-- Register Form -->
                        <form action="index.php?method=registerClick&controller=Main" method="post">
