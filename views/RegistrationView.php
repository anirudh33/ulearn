...
<body>
	...
	<div id="cc">
		...
		<div id="image">
			...
			<div id="registerdiv">
				<form action="index.php?method=registerUser&controller=Main" method="POST" class="register">
					<h1>Registration</h1>
					<fieldset class="row1">
					...
					<fieldset class="row3">
						...
						<p>
							<label>Gender *</label> <input type="radio" name="gender" value="male" /> <label
								class="gender">Male</label> <input type="radio" name="gender" value="female" />
							<label class="gender">Female</label>
						</p>
						<p><label>Date:</label>
						 <input type="text" name="date" id="datepicker" /></p>
							
						<p>
							<label>User Type * </label> <label>Student </label><input type="radio" name="usertype" value="student" /> <label>Teacher </label> <input type="radio" name="usertype" value="teacher" />
						</p>
