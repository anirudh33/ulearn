...
<body>
	...
	<div id="cc" width="5px" height="150px" align="center">
			...
			<div id="registerdiv" >
				...
				<form id="form" action="index.php?method=editStudentClick&controller=Student"
					...
					<fieldset class="row2">
						...
						<p>
							<label>First Name * </label> <input type="text" id="firstname" name="firstname" class="long" 
							value=<?php echo $data[0]['firstname']?>
							onfocus="if(this.value === 'Firstname required') this.value = '';">
						</p>
						<p>
							<label>Last Name * </label> <input type="text" id="lastname" name="lastname" class="long" 
							value=<?php echo $data[0]['lastname']?>
							onfocus="if(this.value === 'Lastname required') this.value = '';">
						</p>
						<p>
							<label>Phone  </label> <input type="text" id="phone" name="phone" maxlength="10" 
							value=<?php echo $data[0]['phone']?>>
							
						</p>

						<p>
							<label>Address  </label> <input type="text" id="address" name="address" class="long" 
						...
						<p>
							<label>Qualification *</label> <input type="text" id="qualification" name="qualification" class="long" 
					...
					<fieldset class="row3">
						...
						<p>
							<label>Gender </label> <input type="text" id="gender" name="gender" class="long" 
							value=<?php echo $data[0]['gender']?>>
							
						</p>
						<p>
							<label>Birthdate * </label> 
							<input type="text" id="dob" name="dob" class="long" 
