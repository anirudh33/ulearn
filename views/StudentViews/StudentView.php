	...
	<div id="toppanel">
		<div id="panel">
			<div class="content clearfix">
				...
				<div class="left">
					<!-- Login Form -->
					<form class="clearfix" action="index.php?method=initiateLogin"
	...
	<div id="cc">
		<div id="langdiv">
			...
			<div id="lang">
				...
				<h3>
					<a href="index.php?method=setLanguageClick&value=EN"><?php echo $lang-> ENGLISH;?></a>
				</h3>
				<h3>
					<a href="index.php?method=setLanguageClick&value=HINDI"><?php echo $lang-> HINDI;?></a>
				</h3>
