...
<h2 align=left> To see the total number of of registered users in Ulearn :</h2>			<br><br>
	<p>
		<label>Total Registrations </label><input type="radio" name="usertype" value="totalregistrations"/>
	</p>
...
<div id="container">
  ...
  <table id="chartData">
    ...
    <tr style="color: #0DA068">
      <td>Students</td><td><?php echo $studentqualificationcount;?></td>
    </tr>
 <tr style="color: #194E9C">
      <td>Teachers</td><td><?php echo $teacherqualificationcount;?></td>
    </tr>
...
<div id="container">
  ...
  <table id="chartData">
    ...
    <tr style="color: #0DA068">
      <td>Students</td><td><?php echo $studentreportdata;?></td>
    </tr>
 <tr style="color: #194E9C">
      <td>Teachers</td><td><?php echo $teacherreportdata;?></td>
    </tr>
